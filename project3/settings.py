...
EMAIL_HOST = '127.0.0.1'  # Local SMTP server
EMAIL_PORT = 1025  # Port we're using for our local SMTP server
EMAIL_USE_TLS = False
EMAIL_USE_SSL = False
EMAIL_HOST_USER = ''  # No authentication needed for local SMTP
EMAIL_HOST_PASSWORD = ''
